...
if [ -z $1 ] || [ ! -d $2 ]; then
    ...
    psql -c "COPY (SELECT * from domainLocationHintsWithDistanceRTTsAnnotated(TIMESTAMP '${oldestDateAllowed}', NULL, false, false) as temp_table) TO '${exportAbsolutDir}/${filename}' CSV HEADER ENCODING 'utf-8';" $1
